...
export default function ContactSection() {
  ...
  return (
    <section 
      id="contact" 
      className="py-20 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-black relative overflow-hidden"
    >
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-4">
            Contact <span 
              ...
              style={{
                filter: 'drop-shadow(0 4px 12px rgba(34, 197, 94, 0.5)) drop-shadow(0 2px 8px rgba(59, 130, 246, 0.4))'
              }}
            >Us</span>
          </h2>
          <div className="w-24 h-1 bg-gradient-to-r from-green-600 to-blue-600 mx-auto mb-6"></div>
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Get in touch with us via WhatsApp for quick responses
          </p>
        </div>

        {/* WhatsApp Contact Card */}
        <div className="max-w-2xl mx-auto">
          <div className="backdrop-blur-md bg-white/20 dark:bg-gray-800/20 rounded-3xl p-12 border border-white/30 dark:border-gray-700/30 shadow-2xl">
            <div className="text-center">
              ...
              <button
                ...
                className="group relative px-10 py-5 bg-gradient-to-r from-green-500 to-green-600 text-white font-bold text-lg rounded-full overflow-hidden transition-all duration-300 hover:scale-110 hover:shadow-2xl"
              >
