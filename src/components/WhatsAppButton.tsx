...
export default function WhatsAppButton() {
  ...
  const webLink = webWhatsAppApiLink(phone);
    ...
    <div className="fixed bottom-6 right-6 z-50">
      <div className="group">
        <button
          ...
          className="relative w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-110"
        >
        ...
        {/* Web fallback as a separate link (not nested inside button) */}
        <a
          href={webLink}
          target="_blank"
          rel="noopener noreferrer"
          className="block mt-2 text-center text-sm text-gray-700 dark:text-gray-300"
        >
          Open WhatsApp Web
        </a>
      </div>
